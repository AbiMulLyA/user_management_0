...
class _UserListPageState extends State<UserListPage> {
  ...
  Future<void> fetchUsers() async {
    ...
    try {
      ...
      // -------------------------------------------------------------------
      // DEBUG PRINT: Melihat response dari API
      // -------------------------------------------------------------------
      // debugPrint digunakan untuk logging karena:
      // - Lebih aman dari print() biasa (tidak akan overflow di release mode)
      // - Bisa handle string panjang dengan memecahnya otomatis
      // -------------------------------------------------------------------
      debugPrint('┌─────────────────────────────────────────────────────────');
